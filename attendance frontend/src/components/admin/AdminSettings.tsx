...
import { useGetGeofenceSettingsQuery, useUpdateGeofenceSettingsMutation } from '../../redux/api/settingsApi';
...
export default function AdminSettings() {
  ...
  const [geofenceLatitude, setGeofenceLatitude] = useState<number>(0);
  const [geofenceLongitude, setGeofenceLongitude] = useState<number>(0);
      ...
      {isSettingsLoading ? (
        ...
        <div className="bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 p-4 rounded-xl flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-theme-muted">{getErrorMsg(settingsError)}</p>
          </div>
        </div>
      ) : (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) => setGeofenceLatitude(Number(e.target.value))}
                    className="w-full bg-theme-card border border-theme-input-border rounded-xl px-3 py-2 text-sm text-theme-bright focus:outline-none focus:border-violet-500 transition-colors"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) => setGeofenceLongitude(Number(e.target.value))}
                    className="w-full bg-theme-card border border-theme-input-border rounded-xl px-3 py-2 text-sm text-theme-bright focus:outline-none focus:border-violet-500 transition-colors"
                  />
                </div>
              </div>
