...
import { useGetShiftsQuery, useCreateShiftMutation, useDeleteShiftMutation } from '../../redux/api/settingsApi';
...
export default function ShiftManagement() {
  ...
  const [gracePeriod, setGracePeriod] = useState<string | number>(15);
  const [errorMsg, setErrorMsg] = useState<string>('');

  const shifts: ShiftItem[] = shiftsResponse?.data || [];
