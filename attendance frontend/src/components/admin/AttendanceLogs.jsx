      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">All clock-in and clock-out activities</p>
          </div>
        </div>
      ...
      {isAttendanceLoading ? (
        ...
        <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 rounded-xl flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">{attendanceError?.data?.message || attendanceError?.error || 'Unknown error'}</p>
          </div>
        </div>
      ) : attendanceLogs.length === 0 ? (
        <div className="py-12 text-center text-slate-500 text-sm">No attendance logs recorded yet.</div>
      ) : (
        <>
